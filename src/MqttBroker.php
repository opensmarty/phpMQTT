...
/**
 * Class MqttBroker
 * @desc A simple php class to connect/publish/subscribe to an MQTT broker
 * @package phpMQTT
 */
class MqttBroker
{
    ...
    /* proc: the processing loop for an "allways on" client set true when you are doing other stuff in the loop good for watching something else at the same time */
